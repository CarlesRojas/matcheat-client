...
export default function Restaurants() {
    ...
    // Contexts
    const { setRoomID, setRoomUsers, isBoss, restaurants, setBackgroundGradient, landingDone, socketError } = useContext(Data);
    ...
    var data = restaurants.current.length ? restaurants.current[0] : {};
